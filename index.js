...
function logMenu(passedList) {
    // passing the array of menu items into the Menu populating function.
    menuCSV = passedList;
    fillMenu(passedList);
}
function fillMenu(passMenu) {
    menuCSV.forEach((e) => {
        // reading the stored array of menu items and determining what category they belong to.
        if (e[5] === "Single item") {
            menuList.push(new MenuItem(e[0], e[1], e[2], e[3], e[4]));
            menuLookup[e[0].split(" ").join(" ")] = new MenuItem(
                e[0],
                e[1],
                e[2],
                e[3],
            ...
            menuList.push(new Category(e[0]));
            menuLookup[e[0].split(" ").join(" ")] = new Category(e[0]);
            menuLookup[e[0].split(" ").join(" ")].popListing();
        } else if (e[5] === "Description") {
            menuList.push(new Description(e[0]));
            ...
            menuLookup[e[0].split(" ").join(" ")] = new Note(e[0]);
            menuLookup[e[0].split(" ").join(" ")].popListing();
        } else if (e[5] === "Toppings") {
            menuList.push(new Toppings(e[0], e[1], e[2], e[3], e[4]));
            menuLookup[e[0].split(" ").join(" ")] = new Toppings(
                e[0],
                e[1],
                e[2],
                e[3],
            ...
            menuLookup[e[0].split(" ").join(" ")] = new PizzaTable(
                e[0],
                e[1],
                e[2],
                e[3],
            ...
            menuLookup[e[0].split(" ").join(" ")] = new PizzaItem(
                e[0],
                e[1],
                e[2],
                e[3],
            ...
            menuLookup[e[0].split(" ").join(" ")] = new DeepDishTable(
                e[0],
                e[1],
                e[2],
                e[3],
            ...
            menuLookup[e[0].split(" ").join(" ")] = new DeepDishItem(
                e[0],
                e[1],
                e[2],
                e[3],
            ...
            menuLookup[e[0].split(" ").join(" ")] = new SpecialPizzaTable(
                e[0],
                e[1],
                e[2],
                e[3],
            ...
            menuLookup[e[0].split(" ").join(" ")] = new SpecialPizzaItem(
                e[0],
                e[1],
                e[2],
                e[3],
            ...
            menuLookup[e[0].split(" ").join(" ")] = new SandwichTable(
                e[0],
                e[1],
                e[2],
                e[3],
            ...
            menuLookup[e[0].split(" ").join(" ")] = new SandwichItem(
                e[0],
                e[1],
                e[2],
                e[3],
...
class MenuItem {
    // mother class of most items takes all the available data
    ...
    popListing() {
        ...
        newDiv.setAttribute(
            "class",
            "text-center food-item  col-xs-12 col-sm-6"
        );
...
class PizzaTable extends MenuItem {
    ...
    popListing() {
        ...
        newTable.setAttribute(
            "class",
            "text-center center col-lg-12 align-center "
        );
